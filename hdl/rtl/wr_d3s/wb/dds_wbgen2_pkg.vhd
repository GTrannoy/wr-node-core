...
package dds_wbgen2_pkg is
  ...
  type t_dds_in_registers is record
    ...
    rf_cnt_trigger_done_sample_i             : std_logic;
  ...
  constant c_dds_in_registers_init_value: t_dds_in_registers := (
    ...
    rf_cnt_trigger_done_sample_i => '0',
    ...
    type t_dds_out_registers is record
      ...
      rf_cnt_trigger_arm_sample_o              : std_logic;
...
tmp.rf_cnt_trigger_done_sample_i := f_x_to_zero(left.rf_cnt_trigger_done_sample_i) or f_x_to_zero(right.rf_cnt_trigger_done_sample_i);
