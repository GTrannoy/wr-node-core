...
#define D3SS_PHFIFO_CSR_USEDW_MASK            WBGEN2_GEN_MASK(0, 10)
#define D3SS_PHFIFO_CSR_USEDW_SHIFT           0
#define D3SS_PHFIFO_CSR_USEDW_W(value)        WBGEN2_GEN_WRITE(value, 0, 10)
#define D3SS_PHFIFO_CSR_USEDW_R(reg)          WBGEN2_GEN_READ(reg, 0, 10)
