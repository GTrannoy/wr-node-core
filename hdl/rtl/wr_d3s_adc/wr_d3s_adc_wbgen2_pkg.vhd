...
-- Created        : Fri Oct 28 19:40:37 2016
-- Standard       : VHDL'87
---------------------------------------------------------------------------------------
...
package d3s_wbgen2_pkg is
  ...
  constant c_d3s_in_registers_init_value: t_d3s_in_registers := (
    ...
    type t_d3s_out_registers is record
      ...
      d3s_adc_usedw_int_o							  : std_logic_vector(13 downto 0);
		ssr_o                                    : std_logic_vector(31 downto 0);
      cr_enable_o                              : std_logic;
      lt_rl_err_min_o                          : std_logic_vector(31 downto 0);
      lt_rl_err_max_o                          : std_logic_vector(31 downto 0);
      st_rl_err_min_o                          : std_logic_vector(31 downto 0);
      st_rl_err_max_o                          : std_logic_vector(31 downto 0);
    ...
    constant c_d3s_out_registers_init_value: t_d3s_out_registers := (
      ...
      adc_wr_full_o => '0',
      adc_wr_empty_o => '0',
      d3s_adc_usedw_int_o => (others => '0'),
		ssr_o => (others => '0'),
      cr_enable_o => '0',
      lt_rl_err_min_o => (others => '0'),
      lt_rl_err_max_o => (others => '0'),
      st_rl_err_min_o => (others => '0'),
      st_rl_err_max_o => (others => '0'),
