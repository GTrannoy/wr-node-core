...
-- Created        : Wed Nov 26 16:17:22 2014
-- Standard       : VHDL'87
---------------------------------------------------------------------------------------
...
package wrn_cpu_csr_wbgen2_pkg is
  ...
  type t_wrn_cpu_csr_in_registers is record
    ...
    debug_jdata_i                            : std_logic_vector(7 downto 0);
    debug_jaddr_i                            : std_logic_vector(2 downto 0);
    debug_rstn_i                             : std_logic;
    debug_tck_i                              : std_logic;
    debug_update_i                           : std_logic;
    end record;
  ...
  constant c_wrn_cpu_csr_in_registers_init_value: t_wrn_cpu_csr_in_registers := (
    ...
    udata_i => (others => '0'),
    debug_jdata_i => (others => '0'),
    debug_jaddr_i => (others => '0'),
    debug_rstn_i => '0',
    debug_tck_i => '0',
    debug_update_i => '0'
    );
    ...
    type t_wrn_cpu_csr_out_registers is record
      ...
      debug_jdata_o                            : std_logic_vector(7 downto 0);
      debug_jdata_load_o                       : std_logic;
      debug_jaddr_o                            : std_logic_vector(2 downto 0);
      debug_jaddr_load_o                       : std_logic;
      debug_rstn_o                             : std_logic;
      debug_rstn_load_o                        : std_logic;
      debug_tck_o                              : std_logic;
      debug_tck_load_o                         : std_logic;
      debug_update_o                           : std_logic;
      debug_update_load_o                      : std_logic;
      end record;
    ...
    constant c_wrn_cpu_csr_out_registers_init_value: t_wrn_cpu_csr_out_registers := (
      ...
      udata_o => (others => '0'),
      udata_load_o => '0',
      debug_jdata_o => (others => '0'),
      debug_jdata_load_o => '0',
      debug_jaddr_o => (others => '0'),
      debug_jaddr_load_o => '0',
      debug_rstn_o => '0',
      debug_rstn_load_o => '0',
      debug_tck_o => '0',
      debug_tck_load_o => '0',
      debug_update_o => '0',
      debug_update_load_o => '0'
      );
...
tmp.debug_jdata_i := f_x_to_zero(left.debug_jdata_i) or f_x_to_zero(right.debug_jdata_i);
tmp.debug_jaddr_i := f_x_to_zero(left.debug_jaddr_i) or f_x_to_zero(right.debug_jaddr_i);
tmp.debug_rstn_i := f_x_to_zero(left.debug_rstn_i) or f_x_to_zero(right.debug_rstn_i);
tmp.debug_tck_i := f_x_to_zero(left.debug_tck_i) or f_x_to_zero(right.debug_tck_i);
tmp.debug_update_i := f_x_to_zero(left.debug_update_i) or f_x_to_zero(right.debug_update_i);
return tmp;
end function;
end package body;
