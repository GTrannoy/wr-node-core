...
-- Created        : Thu Aug 13 10:03:43 2015
-- Standard       : VHDL'87
---------------------------------------------------------------------------------------
...
package wrn_cpu_lr_wbgen2_pkg is
  ...
  type t_wrn_cpu_lr_in_registers is record
    ...
    delay_cnt_delay_i                        : std_logic_vector(31 downto 0);
    app_id_app_id_i                          : std_logic_vector(31 downto 0);
    end record;
  ...
  constant c_wrn_cpu_lr_in_registers_init_value: t_wrn_cpu_lr_in_registers := (
    ...
    tai_sec_i => (others => '0'),
    gpio_in_i => (others => '0'),
    delay_cnt_delay_i => (others => '0'),
    app_id_app_id_i => (others => '0')
    );
    ...
    type t_wrn_cpu_lr_out_registers is record
      ...
      delay_cnt_delay_o                        : std_logic_vector(31 downto 0);
      delay_cnt_delay_load_o                   : std_logic;
      end record;
    ...
    constant c_wrn_cpu_lr_out_registers_init_value: t_wrn_cpu_lr_out_registers := (
      ...
      dbg_chr_o => (others => '0'),
      dbg_chr_wr_o => '0',
      delay_cnt_delay_o => (others => '0'),
      delay_cnt_delay_load_o => '0'
      );
...
tmp.delay_cnt_delay_i := f_x_to_zero(left.delay_cnt_delay_i) or f_x_to_zero(right.delay_cnt_delay_i);
tmp.app_id_app_id_i := f_x_to_zero(left.app_id_app_id_i) or f_x_to_zero(right.app_id_app_id_i);
return tmp;
end function;
end package body;
