...
-- Created        : Mon Jan 23 15:10:33 2017
-- Standard       : VHDL'87
---------------------------------------------------------------------------------------
...
package wrn_cpu_csr_wbgen2_pkg is
  ...
  type t_wrn_cpu_csr_in_registers is record
    ...
    tpu_csr_present_i                        : std_logic;
    tpu_csr_ready_i                          : std_logic;
    tpu_csr_probe_count_i                    : std_logic_vector(4 downto 0);
    tpu_probe_csr_pc_i                       : std_logic_vector(23 downto 0);
    tpu_probe_csr_core_id_i                  : std_logic_vector(3 downto 0);
    tpu_probe_csr_action_i                   : std_logic_vector(3 downto 0);
    tpu_buf_count_i                          : std_logic_vector(15 downto 0);
    tpu_buf_size_i                           : std_logic_vector(15 downto 0);
    tpu_buf_data_id_i                        : std_logic_vector(4 downto 0);
    tpu_buf_data_tstamp_i                    : std_logic_vector(26 downto 0);
    end record;
  ...
  constant c_wrn_cpu_csr_in_registers_init_value: t_wrn_cpu_csr_in_registers := (
    ...
    tpu_csr_present_i => '0',
    tpu_csr_ready_i => '0',
    tpu_csr_probe_count_i => (others => '0'),
    tpu_probe_csr_pc_i => (others => '0'),
    tpu_probe_csr_core_id_i => (others => '0'),
    tpu_probe_csr_action_i => (others => '0'),
    tpu_buf_count_i => (others => '0'),
    tpu_buf_size_i => (others => '0'),
    tpu_buf_data_id_i => (others => '0'),
    tpu_buf_data_tstamp_i => (others => '0')
    );
    ...
    type t_wrn_cpu_csr_out_registers is record
      ...
      tpu_csr_enable_o                         : std_logic;
      tpu_csr_force_start_o                    : std_logic;
      tpu_csr_probe_sel_o                      : std_logic_vector(4 downto 0);
      tpu_probe_csr_pc_o                       : std_logic_vector(23 downto 0);
      tpu_probe_csr_pc_load_o                  : std_logic;
      tpu_probe_csr_core_id_o                  : std_logic_vector(3 downto 0);
      tpu_probe_csr_core_id_load_o             : std_logic;
      tpu_probe_csr_action_o                   : std_logic_vector(3 downto 0);
      tpu_probe_csr_action_load_o              : std_logic;
      tpu_buf_addr_o                           : std_logic_vector(15 downto 0);
      end record;
    ...
    constant c_wrn_cpu_csr_out_registers_init_value: t_wrn_cpu_csr_out_registers := (
      ...
      smem_op_o => (others => '0'),
      tpu_csr_enable_o => '0',
      tpu_csr_force_start_o => '0',
      tpu_csr_probe_sel_o => (others => '0'),
      tpu_probe_csr_pc_o => (others => '0'),
      tpu_probe_csr_pc_load_o => '0',
      tpu_probe_csr_core_id_o => (others => '0'),
      tpu_probe_csr_core_id_load_o => '0',
      tpu_probe_csr_action_o => (others => '0'),
      tpu_probe_csr_action_load_o => '0',
      tpu_buf_addr_o => (others => '0')
      );
...
tmp.tpu_csr_present_i := f_x_to_zero(left.tpu_csr_present_i) or f_x_to_zero(right.tpu_csr_present_i);
tmp.tpu_csr_ready_i := f_x_to_zero(left.tpu_csr_ready_i) or f_x_to_zero(right.tpu_csr_ready_i);
tmp.tpu_csr_probe_count_i := f_x_to_zero(left.tpu_csr_probe_count_i) or f_x_to_zero(right.tpu_csr_probe_count_i);
tmp.tpu_probe_csr_pc_i := f_x_to_zero(left.tpu_probe_csr_pc_i) or f_x_to_zero(right.tpu_probe_csr_pc_i);
tmp.tpu_probe_csr_core_id_i := f_x_to_zero(left.tpu_probe_csr_core_id_i) or f_x_to_zero(right.tpu_probe_csr_core_id_i);
tmp.tpu_probe_csr_action_i := f_x_to_zero(left.tpu_probe_csr_action_i) or f_x_to_zero(right.tpu_probe_csr_action_i);
tmp.tpu_buf_count_i := f_x_to_zero(left.tpu_buf_count_i) or f_x_to_zero(right.tpu_buf_count_i);
tmp.tpu_buf_size_i := f_x_to_zero(left.tpu_buf_size_i) or f_x_to_zero(right.tpu_buf_size_i);
tmp.tpu_buf_data_id_i := f_x_to_zero(left.tpu_buf_data_id_i) or f_x_to_zero(right.tpu_buf_data_id_i);
tmp.tpu_buf_data_tstamp_i := f_x_to_zero(left.tpu_buf_data_tstamp_i) or f_x_to_zero(right.tpu_buf_data_tstamp_i);
return tmp;
end function;
end package body;
